export default function PrivacyPolicy() {
	return <div className="center Pad" >
		...
		<div>
			...
			<br />
			<p>
				Eine Datenübermittlung an Weitere, abgesehen von den Genannten erfolgt nicht.
			</p>
			<br />
			<p>
			...
			{/*
					...
					Eine Datenübermittlung an Dritte erfolgt nicht, mit Ausnahme der Übermittlung der Kreditkartennummer an abwickelnde Bankinstitute/Zahlungsdienstleister
