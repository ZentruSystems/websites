...
export default function DialAppTermsAndConditions() {
	...
	return <div className="Pad">
		...
		<p>Welcome to DialApp. These Terms and Conditions ("Terms") govern your use of our macOS application (the "App") and our associated web checkout services (the "Service"), operated by <b>Zentru Systems e.U.</b> ("we", "us", or "our").</p>
