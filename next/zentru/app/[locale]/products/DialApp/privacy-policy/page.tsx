...
export default function DialAppPrivacyPolicy() {
	...
	return <div className="Pad">
		...
		<div>
			...
			<p>This Privacy Policy explains how <b>Zentru Systems e.U.</b> ("we", "us", or "our") collects, uses, and protects your personal data when you use our macOS application (the "App") and our associated web checkout services (the "Service").</p>
			...
			<p>To exercise any of these rights, please contact us at <a href="mailto:service@zentru.systems">service@zentru.systems</a>. You also retain the right to lodge a formal complaint with your local Data Protection Authority.</p>
			<br />
