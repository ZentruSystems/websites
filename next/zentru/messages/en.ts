export default {
	...
	"Products": {
		...
		"DialApp": {
			...
			"terms": {
				...
				"terms": `<p>Welcome to DialApp. These Terms and Conditions ("Terms") govern your use of our macOS application (the "App") and our associated web checkout services (the "Service"), operated by <b>Zentru Systems e.U.</b> ("we", "us", or "our").</p>
	...
	"Main": {
		"because1": "Because we want customers to be treated well.",
		"because2": "Because we care about good design.",
		...
		"weBelieve": `We believe that whatever we do, we should do it really good.<br></br>
			...
			<span>{quoteer, select, us {As we put it} other {As {quoteer} put it}}</span>`,
		...
		// The About section at the end of /about. Anchored at #about, linked from the footer.
		"about": {
			"title": "About me",
	...
	"Fields": {
		...
		"projectBootstrap": {
			...
			"cases": {
				...
				"intro": "Two we bootstrapped and managed, one we built.",
				...
				"items": {
					"forecasting": {
						...
						"work": `Set up the project management tools, planned the idea into a system, and created,
							...
							timeline at risk, we stepped in and built it ourselves.`,
			...
			"process": {
				...
				"steps": {
					...
					"plan": {
						...
						"text": "We work out the current state and the solutions, then create the timeline and the architecture.",
					},
					"implement": {
			...
			"faq": {
				...
				"items": {
					"software": {
						...
						"answer": "Yes. We start from the tools you already use and build around them.",
					},
					"knowledge": {
					...
					"handover": {
						...
						"answer": `Yes. We build the setup, and onboard your team on it, so that your managers can step in
							and onboard new hires themselves.`,
					},
					"breaks": {
						"question": "What happens if something stops working?",
						"answer": `You can always reach out to us. With our standard setup we also let you know about problems
